      ...
      >
        {layout === "page" ? (
          <div className="flex flex-1 flex-col md:justify-around lg:justify-between md:py-10 lg:py-20 ">
            ...
            How can we 
              <span className="text-[#0C6480] block">help you?</span>
            </h2>
            <div className="hidden md:flex">
              ...
              <div className="flex flex-col mr-6">
                <div className="flex items-center mb-2">
                  ...
                  <p className="text-sm ml-2">Cellphone</p>
                </div>
                <span className="text-gray-500 text-sm line-clamp-1">
                +5493813201906
                </span>
          ...
          <div className="flex flex-1 flex-col justify-between md:py-20 ">
            ...
            Do you have any questions? <br /> Contact us and we will advise you!
            </h3>
            {/* <p className="hidden md:block text-gray-500 md:w-10/12">
            ...
            <div className="py-4 mb-4">
              <p className="text-gray-500 text-base">Cellphone</p>
        ...
        >
          ...
          >
            {layout !== "page" && (
              <h3 className="text-3xl mb-8 font-semibold">Email us</h3>
            )}
            <Formik
