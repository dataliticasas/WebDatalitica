    ...
    <section>
      <div className="w-full flex justify-center" id="paneles">
        <div className="w-full max-w-6xl px-4">
          ...
          We develop dynamic dashboards where you can interactively visualize data, 
          providing a key tool for monitoring and analyzing the state of your company, 
          seeking to expose trends, possible problems, find answers and view metrics in real time. 
          The dashboards feature multiple filters, interactive graphs, maps and automated periodic reports, 
          allowing decision makers to save time on operational tasks and focus on what only they can do.
          </p>
        </div>
      </div>
