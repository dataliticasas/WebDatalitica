      ...
      <div className="w-full flex justify-center" id="desarrollo">
        <div className="w-full max-w-6xl px-4">
          ...
          <p className="hidden md:block mb-10">
            Desarrollamos aplicaciones portables adecuandonos a las necesidades
            de los clientes, apuntando a simplificar y automatizar sus procesos.
            Estas permiten agilizar la carga de datos, desde cualquier lugar,
            incluso sin conexión, ver la información actualizada en tiempo real
            y configurar el envío de notificaciones, correos y mensajes de
            texto.
          </p>
        </div>
      </div>
